...
//TODO Убрать setDataProvider(dp); из конструкторов
    ...
    public ZoneField(String name) {
        super(name);
        setDataProvider(dp);
    }

    public ZoneField(String name, String label) {
        super(name, label);
        setDataProvider(dp);
    }

    public ZoneField(String name, String label, boolean required) {
        super(name, label, required);
        setDataProvider(dp);
    }

    public ZoneField(String name, boolean required) {
        super(name, required);
        setDataProvider(dp);
    }
